...
public interface ScoreRepository extends JpaRepository<ScoreCard, Long> {
    ...
    /**
     * Retrieves a list of {@link com.gamification.game.domain.LeaderBoardRow}s representing the Leader Board
     * of users and their total score.
     *
     * @return the leader board sorted by highest score first
     */
    @Query("SELECT NEW com.gamification.game.domain.LeaderBoardRow(s.userId, SUM(s.score)) " +
            "FROM ScoreCard s " +
